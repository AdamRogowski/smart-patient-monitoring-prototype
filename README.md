...
This group project was developed as part of the IoT Prototyping course at DTU. The primary objective was to design a prototype leveraging LoRaWAN communication and an Azure backend. In addition to technical considerations, we also took into account the market potential of the solution and addressed supplementary requirements for inclusiveness.
